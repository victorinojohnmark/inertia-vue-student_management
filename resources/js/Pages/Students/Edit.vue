...
<template>
    ...
    <AuthenticatedLayout>
    <template #header>
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Update Student</h2>
    </template>
                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <select id="class_id" v-model="form.class_id"
                                            ...
                                            <option v-for="classItem in classes.data" :key="classItem.id" :value="classItem.id">{{ classItem.name }}</option>
                                        </select>
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <select id="section_id" v-model="form.section_id"
                                            ...
                                            <option v-for="sectionItem in sections.data" :key="sectionItem.id" :value="sectionItem.id">{{ sectionItem.name }}</option>
                                        </select>
